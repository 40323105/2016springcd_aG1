...
aG1 = Blueprint('aG1', __name__, url_prefix='/aG1', template_folder='templates')
...
@aG1.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@aG1.route('/circle1/<x>/<degree>', defaults={'y': 0})
@aG1.route('/circle1/<x>/<y>/<degree>')
#@aG1.route('/circle1/<int:x>/<int:y>/<int:degree>')
def drawcircle1(x,y,degree):
    return head_str + chain_str + circle1(int(x), int(y), int(degree)) + tail_str
 
 
@aG1.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@aG1.route('/circle2/<x>/<degree>', defaults={'y': 0})
@aG1.route('/circle2/<x>/<y>/<degree>')
#@aG1.route('/circle2/<int:x>/<int:y>/<int:degree>')
def drawcircle2(x,y,degree):
    return head_str + chain_str + circle2(int(x), int(y), int(degree)) + tail_str
 
 
@aG1.route('/twocircle/<x>/<y>')
@aG1.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@aG1.route('/eighteenthirty/<x>/<y>')
@aG1.route('/eighteenthirty', defaults={'x':0, 'y':0})
...
# 壓力角
pa = 20
Spur(ctx).Gear(x, y, r/6, n, pa, "yellow")
Spur(ctx).Gear(x, y+138, r/6, n, pa, "green")
Spur(ctx).Gear(x, y+276, r/6, n, pa, "blue")
Spur(ctx).Gear(x, y-138, r/6, n, pa, "orange")
Spur(ctx).Gear(x, y-276, r/6, n, pa, "red")
